...
class ProductTest < Test::Unit::TestCase
  ...
  def test_add_metafields_to_product
    ...
    field = @product.add_metafield(ShopifyAPI::Metafield.new(:namespace => "contact", :key => "email", :value => "123@example.com", :type => "string"))
    assert_equal ActiveSupport::JSON.decode('{"metafield":{"namespace":"contact","key":"email","value":"123@example.com","type":"string"}}'), ActiveSupport::JSON.decode(FakeWeb.last_request.body)
